...
<html lang="pt-BR">
    ...
    <body style="max-width: 100%; overflow: hidden; background-color: #a1c2de">
        ...
        <%
            ...
            } else if (ac.isAcessoconsultarusuario() == true) {
            ...
            switch (tipo) {
                case "a": %><script src="scripts/navbarGerente.js"></script><%
                                    ...
                                    List<Usuario> usuarios = usuario.consultarGeral();
        ...
        <tbody>
            ...
            <tr>
                ...
                ex: out.write("" + dado); -->
                <td><% out.write("" + u.getidCpf());%></td>
                <td><% out.write(u.getUsuario());%></td>

                <!-- botao para editar o cliente -->
                <td><%out.write("<a href=alterarUsuario.jsp?cpf=" + u.getidCpf() + ">Alterar Usuario</a>");%></td>
                <td><%out.write("<a href=alterarAcesso.jsp?user=" + u.getUsuario() + ">Permissões</a>");%></td>
