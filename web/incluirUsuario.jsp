    ...
    <body onload="validaStatus()" style="max-width: 100%; overflow: hidden; background-color: #a1c2de">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <form id="form" action="receberDadosUsuario.jsp"  method="POST">
                        ...
                        <button id="botaoEnviar" name="botaoEnviar" type="submit"  class="btn btn-primary rounded-pill btn-outline-light my-2 my-sm-0">Cadastrar Usuario</button>
                        ...
                        <!-- script que impede o usuario digitar letra ou caracter nos campos que é solicitado numero -->
                        <script>
        ...
        <script>
            ...
            function validaStatus() {
                ...
                switch (status) {
                    case "1":
                        alert("Este usuario já possui cadastro!");
                        break;
                    case "2":
                    ...
                    case "3":
                        ...
                        break;
                    case "4":
                        alert("Ja existe um usuario cadastrado com este CPF!");
                        break;    
                    case "0":
                        break;
                    default:
